...
public class StaticArrayConcept {
	...
	public static void main(String[] args) {
		...
		// System.out.println(i); Dont write like this // this will give the address of
		// i
		...
		System.out.println("-------using for each loop reverse order");
		...
		// Cases:
		//1. flight booking seats
		//2.Movie tickets
		//3. dropdown months[12]
