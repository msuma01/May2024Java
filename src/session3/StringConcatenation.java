...
public class StringConcatenation {
	...
	public static void main(String[] args) {
		// String is a class and all classes ahould start with capital:default class
		// Dtring can be addded with any datatype
		...
		System.out.println(x+y+q+o);// HelloSelenium10040
		...
		System.out.println(c1);//a
		System.out.println((byte)c1);//97 // To know the ASCII number
